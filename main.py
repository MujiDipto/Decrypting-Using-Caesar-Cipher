...
"""
Decrypt a given plaintext using the Caesar Cipher.
"""
...
label_info = tk.Label(root, text = "Enter the text to decrypt and provide the key")
...
button = tk.Button(text='Decrypt!', command = decrypt)
